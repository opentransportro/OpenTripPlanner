...
/**
 * OSM way properties for Finnish roads. RomaniaWayPropertySetSource is derived from NorwayPropertySetSource by vvesa
...
public class RomaniaWayPropertySetSource implements WayPropertySetSource {
  ...
  public void populateProperties(WayPropertySet props) {
     ...
     *
     */
    props.setCarSpeed("highway=motorway", 30.55f); // = 100kph. Varies between 90 - 130 kph depending on road and season.
    props.setCarSpeed("highway=motorway_link", 16.66f); // = 60kph
    props.setCarSpeed("highway=trunk", 22.22f); // 80kph "Autostrada"
    props.setCarSpeed("highway=trunk_link", 16.66f); // = 60kph
    props.setCarSpeed("highway=primary", 25f); // 90kph "Drum principal"
    props.setCarSpeed("highway=primary_link", 16.66f); // = 60kph
