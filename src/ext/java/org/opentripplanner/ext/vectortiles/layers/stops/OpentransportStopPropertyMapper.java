...
public class OpentransportStopPropertyMapper extends PropertyMapper<TransitStopVertex> {
  private final Graph graph;

  public static OpentransportStopPropertyMapper create(Graph graph) {
    return new OpentransportStopPropertyMapper(graph);
  }

  private OpentransportStopPropertyMapper(Graph graph) {this.graph = graph;}
