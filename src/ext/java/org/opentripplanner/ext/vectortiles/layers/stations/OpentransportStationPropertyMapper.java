...
public class OpentransportStationPropertyMapper extends PropertyMapper<Station> {
  private final Graph graph;

  private OpentransportStationPropertyMapper(Graph graph) {this.graph = graph;}

  public static OpentransportStationPropertyMapper create(Graph graph) {
    return new OpentransportStationPropertyMapper(graph);
  }
