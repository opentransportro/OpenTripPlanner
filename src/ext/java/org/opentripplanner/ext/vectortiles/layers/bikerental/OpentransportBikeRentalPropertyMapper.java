...
public class OpentransportBikeRentalPropertyMapper extends PropertyMapper<BikeRentalStation> {
  public static OpentransportBikeRentalPropertyMapper create(Graph graph) {
    return new OpentransportBikeRentalPropertyMapper();
  }
